...
async def run_llm_plan(prompt: str) -> Dict[str, Any]:
    ...
    system = (
        ...
        "Architecture recipes: colosseum = stacked tori (rings) of shrinking "
        "R + a sand floor cylinder; gabled roof = two rotated boxes meeting "
        "at a ridge; pagoda roof = wide cylinder r2->0.3; tower = cylinder + "
        "crenellation boxes. Describe dimensions precisely and compose.\n"
